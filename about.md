...
<section class="about-hero">
  <div class="container">
    ...
    <p class="lead">Step into the twilight at the end of the day.</p>
  </div>
</section>
...
The band is made up of four eclectic musical souls from varying backgrounds and cultures, who have been forged into a singular entity. This strange ship of fools with Dr Crow at the helm is propelled by sonic energy from outside time and space channeled by the band. Dr Crow determinedly soars, swoops, exhorts and entices all present to enter **The Forbidden Zone!**
...
And many other groups, tribes and clubs. As a result of their collective experiences they have made up their own minds and think for themselves. They now live in the forest with the wolves.
...
<section class="about-acid bg-surface-low">
  <div class="container" markdown="1">
    ## ACID
    {% include video_embed.html wix_video_url="https://video.wixstatic.com/video/11062b_e7a88b793118451b934bfdbd6dff7aca/1080p/mp4/file.mp4" %}
  </div>
</section>
...
![The Castle]({{ 'illustrations/castle-_sizedba2a.jpg' | relative_url }})
...
![The Library]({{ 'illustrations/Web-BW-Library-139a2.jpg' | relative_url }})
...
<p class="cta">
  <strong>Abandon the straight and narrow.</strong><br>
  <strong>Stray from the path.</strong>
</p>
